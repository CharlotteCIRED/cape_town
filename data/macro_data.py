...
class MacroData:
    ...
    def import_macro_data(self, param, option, t):
        ...
        income_distribution = numpy.matlib.repmat(income_2011.INC_med, len(scenario.Year), 1)
        ...
        macro_spline_inc_distribution = interp1d(scenario.Year[~np.isnan(scenario.Inc_avg)] - param["year_begin"], np.transpose(income_distribution[~np.isnan(scenario.Inc_avg), 2:12]), method)
        ...
        if option["future_construction_RDP"] == 1:
            ...
            macro_spline_RDP = interp1d([2001 - param["year_begin"], 2011 - param["year_begin"], 2018 - v, 2041 - param["year_begin"]], [RDP_2011 - 10*5000, RDP_2011, RDP_2011 + 7*5000, RDP_2011 + 7*5000], method)
