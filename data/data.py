...
class ImportDataCourbe:
    ...
    def import_data(self, grille, param):
        ...
        data_courbe_DU_Size = sal_coord.AvgDUSz #taille moyenne des logements formels
        ...
        data_courbe_DENS_HFA_informal = (sal_coord.BF_ExtAdj /(sal_coord.Area_sqm / 1000000)) - data_courbe_DENS_HFA_formal #nombre de m2 construits informel / km2
        ...
        for i in range(0, len(data_courbe_SP_Code)):
            data_courbe_SP_area_urb_from_EA[i] = sum(ea_data.ALBERS_ARE[(ea_data.SP_CODE == data_courbe_SP_Code[i]) & ((ea_data.EA_TYPE_C == 1) | (ea_data.EA_TYPE_C == 6) )]) #Surface en km2 des EA type 1 et 6
            data_courbe_SP_formal_dens_HFA[i] = sum(data_courbe_SAL_total_formal_HFA[data_courbe_SP_Code_SAL == data_courbe_SP_Code[i]] / 1000000) / data_courbe_SP_area_urb_from_EA[i] #Densités de logements dans les EA de type 1 et 6
