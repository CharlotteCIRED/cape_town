...
def compute_outputs_from_utility(Uo, param, option, trans_tmp_cout_generalise, grid, transaction_cost_in, housing_limite_ici, rent_reference, 
    ...
    """ Compute the outputs of the model from Uo.
    
    In particular, compute rents, densities, housing supply, dwellings sizes,
    and number of workers per employment center.
